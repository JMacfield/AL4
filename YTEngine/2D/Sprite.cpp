...
void Sprite::Initialize(Vector2 size, uint32_t textureIndex, bool isFlipX, bool isFlipY) {
...
void Sprite::Draw(const Transform& transform, const Transform& uvTransform, const Vector4& material) {
...
void Sprite::SetTextureLTSize(Vector2 textureLeftTop, Vector2 textureSize) {
	textureLeftTop_ = textureLeftTop;
	textureSize_ = textureSize;
}

void Sprite::SetTextureInitialSize() {
	AdjustTextureSize();
	size_ = textureSize_;
}
...
void Sprite::SetZPoint(float Zpoint) {
	Zpos_ = Zpoint;
}