...
//		
//		Vector3 worldPos = worldTransformBody_.GetWorldPosition();
...
//		
//		if (CompareVector3(move, { 0.0f,0.0f,0.0f })) {
//			isMove_ = false;
//		}
//		else {
//			isMove_ = true;
...
//			//quaternionの合成
//			quaternion_ = Norm(quaternion_);
//			newquaternion_ = Norm(newquaternion_);
//
//			quaternion_ = Multiply(quaternion_, newquaternion_);
//			if (CompareQuaternion(quaternion_, preQuaternion_) && !CompareVector3(move, preMove_)) {
//				cosin = -1.0f;
